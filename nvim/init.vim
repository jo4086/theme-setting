...
" 줄바꿈
inoremap <C-A-Down> <Esc>$o
inoremap <C-A-Up> <Esc>$O
...
" <Tab> 을 눌렀을 때 자동완성 후보 선택 or 들여쓰기
...
" 태그 닫기 설정
let g:closetag_filenames = '*.html,*.xthml,*.pthml' " 적용할 파일 확장자
let g:closetag_xhtml_filenames = '*.xthml,*.jsx' 	" XTHML처럼 닫기
let g:closetag_filetypes = 'html,xthml,phtml'		" 적용할 파일 타입
